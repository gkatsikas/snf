 ...
 */
bool
Graph::contains(unsigned short pos) {
 ...
 */
void
Graph::add_edge(Vertex* u, Vertex* v, unsigned short input_port_v) {
 ...
 */
Vertex*
Graph::get_vertex_by_name(std::string& name) {
	if ( this->is_empty() )
		return NULL;
 ...
 */
Vertex*
Graph::get_vertex_by_position(unsigned short pos) {
	if ( this->is_empty() )
		return NULL;
 ...
 */
std::vector<Vertex*>
Graph::get_vertex_children(Vertex* u) {
 ...
 */
void
dfs(Vertex* vertex, Colour& colour, const Graph::AdjacencyList& adjacency_list,
