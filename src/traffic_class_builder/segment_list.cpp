...
{
	if ( !container || !to_substract ) { // There's nothing to substract or to substract from
		return container;
	}
...
void
DisjointSegmentList::update_relation(std::shared_ptr<SegmentNode> parent, std::shared_ptr<SegmentNode> child)
{
