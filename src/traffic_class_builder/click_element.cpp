...
ClickElement::ClickElement (ElementVertex* ev, short input_port) :
...
void
ClickElement::set_child (std::shared_ptr<ClickElement> child, int port, int next_input_port) {
	DEBUG("Adding child "+element_names[child->get_type()]+" to "+to_str());
...
int
ClickElement::get_nbPorts() const {
	return m_nbPorts;
}

void
ClickElement::set_nbPorts(int nbPorts) {
	m_nbPorts = nbPorts;
}

std::vector<OutputClass>
ClickElement::get_outputClasses() const {
...
void
ClickElement::set_nfName (const std::string& name) {
	this->m_nfName = name;
}

std::string
ClickElement::get_nfName () const {
	return this->m_nfName;
}

std::string
ClickElement::to_str() const {
	return element_names[m_type]+" with configuration \""+m_configuration+"\"";
}
...
void
ClickElement::parse_ip_rewriter (const std::string& configuration, short input_port, 
...
void
ClickElement::configuration_fail(unsigned int line, std::string filename) {
