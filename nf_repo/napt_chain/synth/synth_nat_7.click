...
ipc0 :: IPClassifier (
	...
	((dst net 16.0.0.0/32) || (dst net 16.0.0.3/32) || (dst net 16.0.0.4/30) || (dst net 16.0.0.8/29) || (dst net 16.0.0.16/28) || (dst net 16.0.0.32/27) || (dst net 16.0.0.64/26) || (dst net 16.0.0.128/25)),
	((dst net 15.0.0.0/32) || (dst net 15.0.0.3/32) || (dst net 15.0.0.4/30) || (dst net 15.0.0.8/29) || (dst net 15.0.0.16/28) || (dst net 15.0.0.32/27) || (dst net 15.0.0.64/26) || (dst net 15.0.0.128/25)),
	((dst net 14.0.0.0/32) || (dst net 14.0.0.3/32) || (dst net 14.0.0.4/30) || (dst net 14.0.0.8/29) || (dst net 14.0.0.16/28) || (dst net 14.0.0.32/27) || (dst net 14.0.0.64/26) || (dst net 14.0.0.128/25)),
	((dst net 13.0.0.0/32) || (dst net 13.0.0.3/32) || (dst net 13.0.0.4/30) || (dst net 13.0.0.8/29) || (dst net 13.0.0.16/28) || (dst net 13.0.0.32/27) || (dst net 13.0.0.64/26) || (dst net 13.0.0.128/25)),
...
ipc0[5] -> DropBroadcasts() -> IPGWOptions($ipAddr0) -> [0]iprw4;
ipc0[6] -> DropBroadcasts() -> IPGWOptions($ipAddr0) -> [0]iprw5;
ipc0[7] -> DropBroadcasts() -> IPGWOptions($ipAddr0) -> [0]iprw6;
ipc0[8] -> DropBroadcasts() -> IPGWOptions($ipAddr0) -> [0]iprw7;
