...
iprw3[1] -> EtherEncap(0x0800, $macAddr1, $gwMACAddr1) -> Queue ($queueSize) -> ToDevice ($iface1, BURST 32, METHOD NETMAP);
iprw3[0] -> Discard ();
...
ipc0 :: IPClassifier (
	...
	(((dst net 12.0.0.0/24) && !((dst net 10.0.0.0/24) || (dst net 11.0.0.0/24) || (dst net 12.0.0.1/32) || (dst net 12.0.0.2/32) || (dst net 200.0.0.1/32)))),
	(((dst net 0.0.0.0/0) && !((dst net 10.0.0.0/24) || (dst net 11.0.0.0/24) || (dst net 12.0.0.0/24) || (dst net 200.0.0.0/24)))) || (((dst net 200.0.0.0/24) && !((dst net 10.0.0.0/24) || (dst net 11.0.0.0/24) || (dst net 12.0.0.0/24) || (dst net 200.0.0.1/32)))),
);
