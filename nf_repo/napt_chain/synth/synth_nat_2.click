...
iprw2::IPRewriter(pattern 11.0.0.1 1024-65535 - - 1 0, DEC_IP_TTL false, CALC_CHECKSUM true);
iprw2[1] -> EtherEncap(0x0800, $macAddr0, $gwMACAddr0) -> Queue ($queueSize) -> ToDevice ($iface0, BURST 32, METHOD NETMAP);
iprw2[0] -> Discard ();
...
/** NAT going to: NF_2,netmap:ns2veth1, BURST 32, METHOD NETMAP **/
