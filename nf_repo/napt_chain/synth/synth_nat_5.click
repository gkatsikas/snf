...
iprw3::IPRewriter(pattern 13.0.0.1 1024-65535 - - 1 0, DEC_IP_TTL false, CALC_CHECKSUM true);
iprw3[1] -> Discard ();
iprw3[0] -> Discard ();

/** NAT going to: NF_2,netmap:ns2veth0, BURST 32, METHOD NETMAP **/
iprw4::IPRewriter(pattern 12.0.0.1 1024-65535 - - 1 0, DEC_IP_TTL false, CALC_CHECKSUM true);
iprw4[1] -> Discard ();
iprw4[0] -> Discard ();

/** NAT going to: NF_4,netmap:ns4veth0, BURST 32, METHOD NETMAP **/
iprw2::IPRewriter(pattern 14.0.0.1 1024-65535 - - 1 0, DEC_IP_TTL false, CALC_CHECKSUM true);
iprw2[1] -> Discard ();
iprw2[0] -> Discard ();
...
iprw5::IPRewriter(pattern 11.0.0.1 1024-65535 - - 1 0, DEC_IP_TTL false, CALC_CHECKSUM true);
iprw5[1] -> EtherEncap(0x0800, $macAddr0, $gwMACAddr0) -> Queue ($queueSize) -> ToDevice ($iface0, BURST 32, METHOD NETMAP);
iprw5[0] -> Discard ();

/** NAT going to: NF_5,netmap:ns5veth1, BURST 32, METHOD NETMAP **/
